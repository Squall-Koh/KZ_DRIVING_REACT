...
const styles: Record<string, React.CSSProperties> = {
  ...
  card: { backgroundColor: '#fff', borderRadius: '16px', padding: '20px', border: '1px solid #f1f3f5', boxShadow: '0 4px 16px rgba(0,0,0,0.18)', marginBottom: '24px' },
  ...
  tripCard: { backgroundColor: '#fff', borderRadius: '16px', border: '1px solid #f1f3f5', boxShadow: '0 4px 16px rgba(0,0,0,0.18)', marginBottom: '12px', overflow: 'hidden' },
