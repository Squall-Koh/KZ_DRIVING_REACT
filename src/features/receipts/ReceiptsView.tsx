...
const styles: Record<string, React.CSSProperties> = {
  ...
  vehicleBadge: { fontSize: 13, fontWeight: 700, color: '#2563eb', whiteSpace: 'nowrap' as const },
  vehicleInfo: { fontSize: 13, color: '#444', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' as const },
