    ...
    <div style={styles.page}>
      ...
      <div style={styles.content}>
        ...
        <div style={styles.card}>
          <div style={styles.cardHeader}>
            ...
            <div style={{
              padding: '4px 10px',
              borderRadius: '12px',
              backgroundColor: DUMMY_DATA.attendance.status === '퇴근 완료' ? 'rgba(34, 197, 94, 0.1)' : 'rgba(43, 92, 255, 0.1)',
              color: DUMMY_DATA.attendance.status === '퇴근 완료' ? '#22c55e' : '#2B5CFF',
              fontSize: '12px',
              fontWeight: 'bold',
            }}>
              {DUMMY_DATA.attendance.status}
            </div>
          </div>
          ...
          <div style={styles.infoGrid}>
            <div style={{ ...styles.infoBox, backgroundColor: 'rgba(43, 92, 255, 0.05)' }}>
              ...
              <span style={styles.infoValue}>{DUMMY_DATA.attendance.checkIn}</span>
            </div>
            <div style={{ ...styles.infoBox, backgroundColor: 'rgba(34, 197, 94, 0.05)' }}>
              ...
              <span style={styles.infoValue}>{DUMMY_DATA.attendance.checkOut}</span>
            </div>
            <div style={{ ...styles.infoBox, backgroundColor: 'rgba(249, 115, 22, 0.05)' }}>
              ...
              <span style={styles.infoValue}>{DUMMY_DATA.attendance.workTime}</span>
            </div>
          </div>
        </div>
        ...
        <div style={styles.tripSectionHeader}>
          ...
          <span style={styles.tripSectionTitle}>운행기록 {DUMMY_DATA.trips.length}건</span>
        </div>

        {DUMMY_DATA.trips.map((trip, idx) => (
...
const styles: Record<string, React.CSSProperties> = {
  ...
  distanceRow: { display: 'flex', alignItems: 'center' },
